...
namespace uPLibrary.Networking.M2Mqtt.Messages
{
    ...
    public class MqttMsgPublish : MqttMsgBase
    {
        ...
        public static MqttMsgPublish Parse(byte fixedHeaderFirstByte, byte protocolVersion, IMqttNetworkChannel channel)
        {
            ...
            byte[] rcvbuf;
            int remainingLength = MqttMsgBase.decodeRemainingLength(channel, out rcvbuf);
            ...
            msg.rcvbuf = new byte[rcvbuf.Length + buffer.Length + 1];
            msg.rcvbuf[0] = fixedHeaderFirstByte;
            Array.Copy(rcvbuf, 0, msg.rcvbuf, 1, rcvbuf.Length);
            Array.Copy(buffer, 0, msg.rcvbuf, 1 + rcvbuf.Length, buffer.Length);
